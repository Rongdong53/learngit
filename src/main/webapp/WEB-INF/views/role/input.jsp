        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input type="text" name="sn" class="ui_input_txt02" value="${role.sn }"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <select multiple="true" name="permissionIds" class="ui_multiselect01 right_select">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <table>
                            <tr>
                                <td>
                                    <select multiple="true" class="ui_multiselect01 mleft_select">
                                ...
                                <td>
                                    <select multiple="true" name="menuIds" class="ui_multiselect01 mright_select">
                                    	<c:forEach items="${role.systemMenus }" var="menu">
                                    		<option value="${menu.id }">${menu.name }</option>
                                    	</c:forEach>
                                    </select>
                                </td>
