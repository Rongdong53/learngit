...
<head>
	...
	<script type="text/javascript" src="/js/jquery/plugin/zTree3.4/jquery.ztree.all-3.4.js"></script>
...
<body>
    ...
    <div id="main">
      	<iframe name="right" id="rightMain" src="/employee/list" frameborder="no" scrolling="auto" width="100%" height="100%" allowtransparency="true"/>
    </div>
</body>
</html>