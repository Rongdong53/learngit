...
<body>
<form name="editForm" action="/systemmenu/saveOrUpdate" method="post" id="editForm">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input class="ui_input_txt02" value="${parentName }" readonly="readonly" disabled="disabled"/>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input type="text" name="sn" class="ui_input_txt02" value="${systemmenu.sn }"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">URL</td>
                    <td class="ui_text_lt">
                        <input type="text" name="url" class="ui_input_txt02" value="${systemmenu.url }"/>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
