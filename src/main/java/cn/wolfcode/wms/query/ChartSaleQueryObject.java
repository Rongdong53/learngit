...
public class ChartSaleQueryObject extends QueryObject {
    ...
    private long clientId = -1L; // 根据客户分组
    ...
    static {
        ...
        groupMap.put("saleman.name", "销售人员");
        groupMap.put("p.name", "货品名称");
        groupMap.put("c.name", "客户");
        groupMap.put("p.brand_name", "品牌");
        groupMap.put("DATE_FORMAT(sa.vdate,'%Y-%m')", "订货日期(月)");
        groupMap.put("DATE_FORMAT(sa.vdate,'%Y-%m-%d')", " 订货日期(日)");
    }
